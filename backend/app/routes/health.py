...
Returns the availability status of all integrated services.
Designed for Vercel/container health checks and monitoring dashboards.
"""
...
async def health_check() -> HealthResponse:
    """
    Return health status of the application and all integrated services.
    ...
    return HealthResponse(
        ...
        services={
            "openrouter": settings.ai_enabled,
